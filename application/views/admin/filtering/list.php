                                            ...
                                            <div class="card" style="border: 1px solid #3DD880; min-height: 50vh;">
                                                <div class="card-body">
                                                    ...
                                                    <form class="forms-sample" action="main-tvone.py" method="POST">
                                                        ...
                                                        <!-- <div class="form-group">
                                                            <label for="nomor_hal_kompas" style="color: black;">Nomor Halaman</label><br>
                                                            <input type="number" class="form-control <?php echo form_error('nomor_hal_kompas') ? 'is-invalid' : '' ?>" name="nomor_hal_kompas" id="nomor_hal_kompas" value="<?php echo set_value('nomor_hal_kompas'); ?>" placeholder="Contoh : 1" required>
                                                            <span style="color: red;"><?php echo form_error('nomor_hal_kompas'); ?></span>
                                                        </div> -->
