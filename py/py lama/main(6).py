...
class Scraper:
    ...
    def get_articles(self, response):
        ...
        for page in range(1, (int(self.pages)*10)/2):
            url = f"{self.base_url}cse/{self.keywords}/-/1/-/-/-/{page}"
            ...
            for article in articles:
                ...
                published_time = article.find("span", {"class": "article__date"}).get_text()
...
if __name__ == '__main__':
    ...
    base_url = f"https://katadata.co.id/search/"
