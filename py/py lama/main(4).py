...
class Scraper:
    ...
    def get_articles(self, response):
        ...
        for page in range(1, int(self.pages)*20):
            url = f"{self.base_url}{page}?type=artikel&q={self.keywords}"
            ...
            for article in articles:
                ...
                published_time = article.find("div", {"class": "news-date"}).get_text().split(",")[1]
                ...
                # published_time = soup2.find("div", {"class": "date"}).get_text().split(",")[1]
...
if __name__ == '__main__':
    ...
    base_url = f"https://search.sindonews.com/go/"
